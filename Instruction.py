...
def app():
    ...
    with c :
        ...
        st.image('I1.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I2.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I3.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I4.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I5.png',use_column_width=True)
        st.text('')
        st.text('')
        st.text('')
        st.text('')
        ...
        st.image('I6.png',use_column_width=True)
        st.markdown("""
            <style>
            .Paragraph {
                background-color: #e1ffca;
            ...
            """,unsafe_allow_html=True)
        st.image('I7.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I8.png',use_column_width=True)
        st.markdown("""
        <style>
            .Paragraph {
                background-color: #e1ffca;
        ...
        """,unsafe_allow_html=True)
        st.image('I9.png',use_column_width=True)
