...
def app():
    ...
    with st.expander("View Image"):
        st.image('Sr_cycle.png',use_column_width=True)
        st.image('Sr.png',use_column_width=True)
    st.text('')
    ...
    with c :
        ...
        """,unsafe_allow_html=True)
    with st.expander("View Image"):
        st.image('F_ES.png',use_column_width=True)
    st.text('')
    ...
    with c :
        ...
        """,unsafe_allow_html=True)
    with st.expander("View Image"):
        st.image('GL_cycle.png',use_column_width=True)
        st.image('F_GS.png',use_column_width=True)
    st.text('')
    ...
    with c :
        ...
        """,unsafe_allow_html=True)
    with st.expander("View Image"):
        st.image('F_TS.png',use_column_width=True)
        st.image('F_TS1.png',use_column_width=True)
    st.text('')
    ...
    with c :
        ...
        """,unsafe_allow_html=True)
    with st.expander("View Image"):
        st.image('nn_cycle.jpg',use_column_width=True)
        st.image('northern.jpg',use_column_width=True)
    st.text('')  
    ...
    with c :
        ...
        """,unsafe_allow_html=True)
    with st.expander("View Image"):
        st.image('F_CR.png',use_column_width=True)
        st.image('F_CR1.png',use_column_width=True)
    st.text('')  
